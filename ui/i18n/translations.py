...
TRANSLATIONS = {
    "en": {
        ...
        # Financial Logic - Scenario Analysis
        "baseline_market_trends": "Baseline Market Trends",
        "current_prices": "Current Prices",
        "trend": "Trend",
        "scenario_probabilities": "Scenario Probabilities",
        "stress_test": "Stress Test - Critical Thresholds",
        "critical_scenario": "Critical Scenario",
        "revenue_drop": "Revenue drop",
        "total_loss": "Total loss",
        "families_impacted": "Families impacted",
        "per_family_impact": "Per Family Impact",
        "normal_income": "Normal income",
        ...
        "by_families": "By Farming Families",
        "cambodia_context": "Cambodia Context",
        "agri_context_note": "Cambodia is the 2nd largest cashew producer globally (after Vietnam). Agricultural exports represent a significant share of rural livelihoods, with an estimated 580,000 families depending on cashew and rubber cultivation.",
    ...
    "fr": {  # French
        ...
        # Financial Logic - Scenario Analysis
        "baseline_market_trends": "Tendances de Base du Marché",
        "current_prices": "Prix Actuels",
        "trend": "Tendance",
        "scenario_probabilities": "Probabilités des Scénarios",
        "stress_test": "Test de Stress - Seuils Critiques",
        "critical_scenario": "Scénario Critique",
        "revenue_drop": "Baisse des revenus",
        "total_loss": "Perte totale",
        "families_impacted": "Familles impactées",
        "per_family_impact": "Impact Par Famille",
        "normal_income": "Revenu normal",
        "stress_income": "Revenu en stress",
        "loss": "Perte",
        "combined_agri_revenues": "Revenus Agricoles Combinés - Cambodge",
        "total_exports": "Exportations Totales",
        "avg_farm_income": "Revenu Moyen/Famille",
        "revenue_distribution": "Répartition des Revenus",
        "by_commodity": "Par Matière Première",
        "by_families": "Par Familles Agricoles",
        "cambodia_context": "Contexte Cambodge",
        "agri_context_note": "Le Cambodge est le 2ème producteur mondial de cajou (après le Vietnam). Les exportations agricoles représentent une part significative des moyens de subsistance ruraux, avec environ 580 000 familles dépendant de la culture du cajou et du caoutchouc.",
