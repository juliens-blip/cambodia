-- Cambodia Agri Analytics - Supabase Schema
...
-- Unique constraint to prevent duplicates on natural key
-- Since PostgreSQL treats NULL as distinct in unique indexes, we need to handle it carefully
-- Option 1: Partial unique index for non-NULL destination_country
...
-- Option 2: Unique index for NULL destination_country cases
