...
**Demande initiale:** Corriger le CSX Index (N/A) et l'auto-refresh Streamlit (erreurs /_stcore/health 404) sur Market Trends en production.
**Objectif:** Stabiliser la connexion Streamlit (auto-refresh OK) et clarifier/fixer l'affichage CSX Index si possible.
...
| ui/pages/5_Market_Trends.py | UI | Macro indicators + fetch CSX index | L75-L242 |
...
- ui/pages/5_Market_Trends.py et ui/pages/6_Scenario_Analysis.py -> etch_mef_json() pour MEF
...
- **CSX index null:** l'endpoint MEF csx-index renvoie des champs alue/change_percent a null (donnees upstream).
...
- Correctif principal: forcer le BACKEND_BASE_URL dans le HTML Streamlit pour stabiliser la connexion.
